...
$PPWCodeRepositories = @{
    ...
    'semantics' = @{
		...
		folder = 'ppwcode-vernacular-semantics'
		git = 'net-ppwcode-vernacular-semantics'
		dependencies = @('exceptions', 'stylecop')
        bookmarks = '01.Code.3'
		wiki = $false
        psake = $true
    }
    'persistence' = @{
		...
		dependencies = @('oddsandends', 'exceptions', 'semantics', 'stylecop')
        bookmarks = '01.Code.4'
		wiki = $false
        psake = $true
    }
    'nhibernate' = @{
		...
		dependencies = @('oddsandends', 'exceptions', 'semantics', 'persistence', 'stylecop')
        bookmarks = '01.Code.5'
		wiki = $false
        psake = $true
    }
    'wcf' = @{
		...
		dependencies = @('oddsandends', 'exceptions', 'stylecop')
        bookmarks = '01.Code.6'
		wiki = $false
        psake = $true
    }
